...
export function UserProfileFormFields(props: UserProfileFormFieldsProps) {
  ...
  const queryParams = useMemo(() => {
    ...
    return {
      email: params.get("loginHint") ?? params.get("login_hint") ?? undefined,
  ...
  useEffect(() => {
    ...
    Object.entries(queryParams).forEach(([fieldName, fieldValue]) => {
      if (fieldValue && fieldStateByAttributeName[fieldName]) {
        const currentValue = fieldStateByAttributeName[fieldName].value;
